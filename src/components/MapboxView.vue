<template>
  <div class="mapbox-page">
    ...
    <div style="  position: absolute;  top: 60px;  right: 60px;  z-index: 99;">
      <el-button v-if="!editBoardShow" size="small" icon="el-icon-arrow-down" @click="handleEditBoardShow(1)">打开编辑框</el-button>
      <el-button v-if="editBoardShow" size="small" icon="el-icon-arrow-up" @click="handleEditBoardShow(0)">收起编辑框</el-button>
    </div>
