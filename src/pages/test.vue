          ...
          <el-table-column label="操作" min-width="115">
            <template slot-scope="scope">
              ...
              <el-popover placement="right" width="200" trigger="click">
                ...
                <el-button
                  v-if="
                    scope.row.type === 'circle' || scope.row.type === 'symbol'
                  "
                  size="mini"
                  type="primary"
        ...
        <el-tab-pane label="样式设置" name="first">
          ...
          >
            <el-tab-pane label="颜色">
              ...
              <br />
              <el-button
                style="padding-left: 10px; padding-right: 50%; width: 100%"
                @click="rateEditShow = true"
              >
                <span>变化率：&nbsp;&nbsp;</span>{{ Rate }}
              </el-button>
              <el-dialog
              ...
              <el-button
                type="text"
                @click="
                  zoomColor.unshift({ zoom: 0, color: '#000000' });
                  zoomEditIndex = 0;
                  zoomEditShow = true;
                "
                >+ 增加zoom级别条件
              ...
              >
                <el-row>
                  <el-input
                    v-model="zoomColor[zoomEditIndex].zoom"
                    placeholder="something"
                    style="width: 80%"
                  >
                ...
                <span slot="footer" class="dialog-footer">
                  ...
                  <el-button type="primary" @click="zoomEditFirm"
                    >确 定</el-button
                  >
                </span>
              </el-dialog>
          ...
          >
            ...
            <el-tab-pane label="图标">
              <h3>图标选择</h3>
              <el-table :data="symbolTableData" style="width: 200px">
                <el-table-column prop="originNmae" label="预览" width="50">
                </el-table-column>
                <el-table-column prop="originName" label="名称" width="100">
                </el-table-column>
            ...
            <el-tab-pane label="倾斜对齐">
              <h3>倾斜对齐</h3>
              <el-select
                v-model="layers[nowLayerIndex].paint['icon-pitch-alignment']"
                placeholder="请选择"
              >
                <el-option
                  ...
                  @change="
                    handlePaintChange(
                      ...
                      layers[nowLayerIndex].paint['icon-pitch-alignment']
                    )
                  "
                >
                </el-option>
        ...
        <el-tab-pane label="数据设置" name="second">
          ...
          <el-form :label-position="right">
            ...
            <el-form-item label="图层类型">
              <el-select
                v-model="layers[this.nowLayerIndex].type"
                placeholder="请选择图层类型"
              >
                <el-option
                  v-for="item in [
          ...
          <el-row v-for="(item, index) in filterCondition" :key="index">
            ...
            ></el-button>
            <el-select
              v-model="filterCondition[index]['options']"
              placeholder="请选择"
            >
              <el-option
          ...
          <el-col v-if="(filterCondition.length = 0)" class="displayBox"
            >未设置过滤条件</el-col
          >
          <el-button
            type="text"
